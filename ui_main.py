...
"}\n"
"QPushButton:hover {\n"
"    background-color: rgb(218, 20, 14);\n"
"}\n"
"QPushButton:pressed {    \n"
"    background-color: rgb(85, 170, 255);\n"
"}")
...
"}")
        ...
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.page_playlists)
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.stackedWidget.addWidget(self.page_playlists)
        self.page_editPlaylist = QtWidgets.QWidget()
        self.page_editPlaylist.setObjectName("page_editPlaylist")
        self.hLayout_15 = QtWidgets.QHBoxLayout(self.page_editPlaylist)
        self.hLayout_15.setObjectName("hLayout_15")
        self.verticalFrame = QtWidgets.QFrame(self.page_editPlaylist)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.playlistEditImage = QtWidgets.QLabel(self.verticalFrame)
        self.playlistEditImage.setMinimumSize(QtCore.QSize(250, 250))
        self.playlistEditImage.setMaximumSize(QtCore.QSize(250, 250))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        self.playlistEditImage.setFont(font)
...
" border-radius: 15px;")
        ...
        self.horizontalLayout_14.addWidget(self.playlistEditImage)
        self.verticalLayout_13 = QtWidgets.QVBoxLayout()
        self.verticalLayout_13.setObjectName("verticalLayout_13")
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_13.addItem(spacerItem1)
        self.playlistEditChangeImage = QtWidgets.QPushButton(self.verticalFrame)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        self.playlistEditChangeImage.setFont(font)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/16x16/icons/16x16/cil-image-plus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.playlistEditChangeImage.setIcon(icon3)
        self.playlistEditChangeImage.setObjectName("playlistEditChangeImage")
        self.verticalLayout_13.addWidget(self.playlistEditChangeImage)
        ...
        self.playlistEditName = QtWidgets.QLineEdit(self.verticalFrame)
        font = QtGui.QFont()
        font.setPointSize(30)
        self.playlistEditName.setFont(font)
        self.playlistEditName.setObjectName("playlistEditName")
        self.verticalLayout_14.addWidget(self.playlistEditName)
        ...
        self.btn_peplay = QtWidgets.QPushButton(self.horizontalFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_peplay.sizePolicy().hasHeightForWidth())
        self.btn_peplay.setSizePolicy(sizePolicy)
        self.btn_peplay.setMinimumSize(QtCore.QSize(0, 50))
        self.btn_peplay.setMaximumSize(QtCore.QSize(16777215, 507215))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.btn_peplay.setFont(font)
        self.btn_peplay.setStyleSheet("background-color: rgb(39, 44, 54);\n"
" border-radius: 15px;")
        self.btn_peplay.setObjectName("btn_peplay")
        self.horizontalLayout_20.addWidget(self.btn_peplay)
        self.btn_pepshuffle = QtWidgets.QPushButton(self.horizontalFrame)
        self.btn_pepshuffle.setMinimumSize(QtCore.QSize(0, 50))
        self.btn_pepshuffle.setMaximumSize(QtCore.QSize(16777215, 50))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.btn_pepshuffle.setFont(font)
        self.btn_pepshuffle.setStyleSheet("background-color: rgb(39, 44, 54);\n"
" border-radius: 15px;")
        self.btn_pepshuffle.setObjectName("btn_pepshuffle")
        self.horizontalLayout_20.addWidget(self.btn_pepshuffle)
        ...
        self.playlistEditDelete = QtWidgets.QPushButton(self.horizontalFrame1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.playlistEditDelete.sizePolicy().hasHeightForWidth())
        self.playlistEditDelete.setSizePolicy(sizePolicy)
        self.playlistEditDelete.setMinimumSize(QtCore.QSize(0, 50))
        self.playlistEditDelete.setMaximumSize(QtCore.QSize(16777215, 50))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.playlistEditDelete.setFont(font)
        self.playlistEditDelete.setFocusPolicy(QtCore.Qt.TabFocus)
        self.playlistEditDelete.setStyleSheet("background-color: rgb(39, 44, 54);\n"
" border-radius: 15px;")
        self.playlistEditDelete.setObjectName("playlistEditDelete")
        self.horizontalLayout_22.addWidget(self.playlistEditDelete)
        self.verticalLayout_14.addWidget(self.horizontalFrame1)
        ...
        self.horizontalLayout_21 = QtWidgets.QHBoxLayout(self.horizontalFrame2)
        ...
        self.verticalLayout_14.addWidget(self.horizontalFrame2)
        spacerItem5 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_14.addItem(spacerItem5)
        self.hLayout_15.addWidget(self.verticalFrame)
        self.verticalFrame1 = QtWidgets.QFrame(self.page_editPlaylist)
        self.verticalFrame1.setStyleSheet("")
        ...
        font.setBold(True)
        font.setWeight(75)
        self.playlistEditAdd.setFont(font)
        self.playlistEditAdd.setStyleSheet("background-color: rgb(39, 44, 54);\n"
" border-radius: 15px;")
        icon4 = QtGui.QIcon()
        ...
        self.page_games.setObjectName("page_games")
        self.vLayout_150 = QtWidgets.QVBoxLayout(self.page_games)
        self.vLayout_150.setSizeConstraint(QtWidgets.QLayout.SetDefaultConstraint)
        self.vLayout_150.setObjectName("vLayout_150")
        self.gameAdd = QtWidgets.QFrame(self.page_games)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gameAdd.sizePolicy().hasHeightForWidth())
        self.gameAdd.setSizePolicy(sizePolicy)
        self.gameAdd.setMinimumSize(QtCore.QSize(0, 100))
        self.gameAdd.setMaximumSize(QtCore.QSize(16777215, 100))
        self.gameAdd.setSizeIncrement(QtCore.QSize(0, 0))
        self.gameAdd.setBaseSize(QtCore.QSize(0, 0))
        self.gameAdd.setStyleSheet("background-color: rgb(39, 44, 54);\n"
" border-radius: 15px;")
        self.gameAdd.setObjectName("gameAdd")
        self.horizontalLayout_16 = QtWidgets.QVBoxLayout(self.gameAdd)
        self.horizontalLayout_16.setObjectName("horizontalLayout_16")
        self.btn_gameAdd = QtWidgets.QPushButton(self.gameAdd)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btn_gameAdd.sizePolicy().hasHeightForWidth())
        self.btn_gameAdd.setSizePolicy(sizePolicy)
        self.btn_gameAdd.setMaximumSize(QtCore.QSize(16777215, 100))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.btn_gameAdd.setFont(font)
        self.btn_gameAdd.setObjectName("btn_gameAdd")
        self.horizontalLayout_16.addWidget(self.btn_gameAdd)
        self.gameAddSearch = QtWidgets.QLineEdit(self.gameAdd)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.gameAddSearch.setFont(font)
        self.gameAddSearch.setInputMask("")
        self.gameAddSearch.setText("")
        self.gameAddSearch.setObjectName("gameAddSearch")
        self.horizontalLayout_16.addWidget(self.gameAddSearch)
        self.vLayout_150.addWidget(self.gameAdd)
        self.gameListHolder = QtWidgets.QFrame(self.page_games)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gameListHolder.sizePolicy().hasHeightForWidth())
        self.gameListHolder.setSizePolicy(sizePolicy)
        self.gameListHolder.setMinimumSize(QtCore.QSize(0, 300))
        self.gameListHolder.setMaximumSize(QtCore.QSize(16777215, 10000000))
        self.gameListHolder.setStyleSheet("")
        self.gameListHolder.setObjectName("gameListHolder")
        self.verticalLayout_16 = QtWidgets.QVBoxLayout(self.gameListHolder)
        self.verticalLayout_16.setObjectName("verticalLayout_16")
        self.vLayout_150.addWidget(self.gameListHolder)
        self.stackedWidget.addWidget(self.page_games)
        self.page_editGame = QtWidgets.QWidget()
        self.page_editGame.setObjectName("page_editGame")
        self.verticalLayout_250 = QtWidgets.QVBoxLayout(self.page_editGame)
        self.verticalLayout_250.setObjectName("verticalLayout_250")
        self.frameTitle = QtWidgets.QFrame(self.page_editGame)
        self.frameTitle.setMaximumSize(QtCore.QSize(16777215, 150))
        self.frameTitle.setObjectName("frameTitle")
        self.horizontalLayout_17 = QtWidgets.QHBoxLayout(self.frameTitle)
        self.horizontalLayout_17.setObjectName("horizontalLayout_17")
        self.gameImage = QtWidgets.QLabel(self.frameTitle)
        self.gameImage.setMinimumSize(QtCore.QSize(140, 140))
        self.gameImage.setMaximumSize(QtCore.QSize(140, 140))
        self.gameImage.setText("")
        self.gameImage.setObjectName("gameImage")
        self.horizontalLayout_17.addWidget(self.gameImage)
        self.gameTitle = QtWidgets.QLabel(self.frameTitle)
        font = QtGui.QFont()
        font.setPointSize(30)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout_18 = QtWidgets.QHBoxLayout(self.frameDecal)
        self.horizontalLayout_18.setObjectName("horizontalLayout_18")
        self.holder1 = QtWidgets.QFrame(self.frameDecal)
        self.holder1.setStyleSheet("background-color: rgb(39, 44, 54);\n"
" border-radius: 15px;")
        self.holder1.setObjectName("holder1")
...
" border-radius: 15px;")
        self.holder2.setObjectName("holder2")
        self.verticalLayout_20 = QtWidgets.QVBoxLayout(self.holder2)
        self.verticalLayout_20.setObjectName("verticalLayout_20")
        self.horizontalLayout_18.addWidget(self.holder2)
        self.verticalLayout_250.addWidget(self.frameDecal)
        self.stackedWidget.addWidget(self.page_editGame)
        self.page_settings = QtWidgets.QWidget()
        self.page_settings.setObjectName("page_settings")
        self.verticalLayout_settings = QtWidgets.QVBoxLayout(self.page_settings)
        self.verticalLayout_settings.setObjectName("verticalLayout_settings")
        self.refreshPlaylistDb = QtWidgets.QFrame(self.page_settings)
        self.refreshPlaylistDb.setMinimumSize(QtCore.QSize(0, 100))
        self.refreshPlaylistDb.setMaximumSize(QtCore.QSize(16777215, 100))
        self.refreshPlaylistDb.setObjectName("refreshPlaylistDb")
        self.horizontalLayout_19 = QtWidgets.QHBoxLayout(self.refreshPlaylistDb)
        self.horizontalLayout_19.setObjectName("horizontalLayout_19")
        self.label = QtWidgets.QLabel(self.refreshPlaylistDb)
        font = QtGui.QFont()
        ...
        self.pushButton_dbrefresh = QtWidgets.QPushButton(self.refreshPlaylistDb)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_dbrefresh.sizePolicy().hasHeightForWidth())
        self.pushButton_dbrefresh.setSizePolicy(sizePolicy)
        self.pushButton_dbrefresh.setMaximumSize(QtCore.QSize(300, 60))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
...
" border-radius: 15px;")
        ...
        self.verticalLayout_settings.addWidget(self.thanks)
...
"")
        ...
        self.MusicPlayer_2 = QtWidgets.QFrame(self.frame_content)
        self.MusicPlayer_2.setStyleSheet("background-color: rgb(33, 37, 43);")
        ...
        self.MusicPoster.setSizeIncrement(QtCore.QSize(0, 0))
        self.MusicPoster.setBaseSize(QtCore.QSize(0, 0))
        self.MusicPoster.setText("")
        self.MusicPoster.setScaledContents(True)
        self.MusicPoster.setObjectName("MusicPoster")
        self.MusicPlayer.addWidget(self.MusicPoster)
        self.BarAndPause_2 = QtWidgets.QFrame(self.MusicPlayer_2)
        self.BarAndPause_2.setStyleSheet("background-color: rgb(39, 44, 54);\n"
" border-radius: 15px;")
        self.BarAndPause_2.setObjectName("BarAndPause_2")
        self.BarAndPause = QtWidgets.QVBoxLayout(self.BarAndPause_2)
        self.BarAndPause.setObjectName("BarAndPause")
        self.frame1 = QtWidgets.QFrame(self.BarAndPause_2)
        self.frame1.setObjectName("frame1")
        self.horizontalLayout_15 = QtWidgets.QHBoxLayout(self.frame1)
        self.horizontalLayout_15.setObjectName("horizontalLayout_15")
        self.frame2 = QtWidgets.QFrame(self.frame1)
        self.frame2.setObjectName("frame2")
        self.verticalLayout_12 = QtWidgets.QVBoxLayout(self.frame2)
        self.verticalLayout_12.setObjectName("verticalLayout_12")
        self.MusicName = QtWidgets.QLabel(self.frame2)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.verticalLayout_12.addWidget(self.MusicName, 0, QtCore.Qt.AlignHCenter)
        self.Bar = QtWidgets.QProgressBar(self.frame2)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.Bar.setProperty("value", 83)
        self.Bar.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        ...
        self.btn_pause.setMaximumSize(QtCore.QSize(50, 50))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.btn_pause.setFont(font)
        self.btn_pause.setStyleSheet("background: transparent;\n"
"\n"
"background-position: center;\n"
"background-repeat: no-repeat;\n"
"color: rgb(170, 255, 0);\n"
"")
        ...
        self.label_2.setPixmap(QtGui.QPixmap(":/16x16/icons/16x16/cil-volume-high.png"))
        ...
        self.frame_grip.setMaximumSize(QtCore.QSize(16777215, 5000))
        ...
        self.frame_label_bottom.setEnabled(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.playlistEditChangeImage.setText(_translate("MainWindow", "Change"))
        self.playlistEditName.setText(_translate("MainWindow", "My Playlist"))
        self.btn_peplay.setText(_translate("MainWindow", "Play"))
        ...
        self.label.setText(_translate("MainWindow", "   Refresh the playlist Database (Can take a time!) :"))
        self.pushButton_dbrefresh.setText(_translate("MainWindow", " Refresh"))
        self.thanks.setText(_translate("MainWindow", "Thanks to Drakz for making the app logo, to Djoe for making a process looking function and to S0dio for making the splash screen image"))
        ...
        self.label_version.setText(_translate("MainWindow", "vB1.3.0"))
import files_rc
